...
interface GeminiResponse {
  founders: GeminiFounderResult[];
  raw: string;
}

/**
 * Extract founder information using Google's Gemini API
 * 
 * @param url - The website URL
 * @param textContent - Scraped text content from the website
 * @returns Array of founder info objects
 */
export const extractFoundersWithGemini = async (
  ...
  try {
    console.log(`[v0] GEMINI: Analyzing ${url}...`);
